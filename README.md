arquetipo-java-avancado: Example Using Multiple Java EE 7 Technologies Deployed as an EAR
==============================================================================================
Author: Pete Muir
Level: Intermediate
...
4. This will deploy `target/arquetipo-java-avancado.ear` to the running instance of the server.
...
You should see messages similar to the following:
    ...
    INFO  [com.boaroli.arquetipo.java.avancado.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [com.boaroli.arquetipo.java.avancado.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
    ...
    INFO  [org.jboss.as.connector.subsystems.datasources] (MSC service thread 1-5) JBAS010409: Unbound data source [jboss/datasources/arquetipo-java-avancadoTestDS]
